...
import { X, User, Mail, Calendar, UserCheck, History } from 'lucide-react';
import { Project, TeamAssignment } from '../../../types';
import { TeamAPI, RoleAPI } from '../../../services/api';
...
// ✅ Utiliser les mêmes noms de rôles que dans la base de données
...
export const ProjectTeamDetailModal: React.FC<ProjectTeamDetailModalProps> = ({
  ...
  // Debug logs
  console.log('📋 ProjectTeamDetailModal - Assignments by role:', assignmentsByRole);
  console.log('📋 ProjectTeamDetailModal - Core roles:', CORE_ROLES);
  ...
  const handleAssign = (roleName: string) => {
    console.log('🎯 Assign clicked for role:', roleName);
